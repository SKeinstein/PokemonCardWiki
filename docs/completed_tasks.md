...
- [x] **35-5** ポケモンいれかえ>自分 の分類ミス（ポケモンいれかえ/スクランブルスイッチ/なみのりビーチ/ダイケンキ/メガカイリューex）を >味方 に修正し、サーファーのマッチ漏れを追加する #claude/queue
> [!success] 2026-05-17 — 7[r8[?25h[?25l[?2004h[?1004h[?2031h]0;✳ Claude Code▗[1C▗[3C▖[1C▖[2CClaude[1CCode[1Cv2.1.143
...
- [x] **35-6** カード種別参照>ポケモンのどうぐ を廃止し、タグルールと付与済みタグデータから削除する #claude/queue
> [!success] 2026-05-17 — 7[r8[?25h[?25l[?2004h[?1004h[?2031h]0;✳ Claude Code▗[1C▗[3C▖[1C▖[2CClaude[1CCode[1Cv2.1.143
...
- [x] **35-8** 独自タグ「自傷」を廃止し、自傷>ダメージを条件ダメージ>自傷に、自傷>ダメカンをダメカン操作>のせるに移動する #claude/queue
...
- [x] **35-8** 独自タグ「自傷」を廃止し、自傷>ダメージを条件ダメージに、自傷>ダメカンをダメカン操作>のせるに移動する #claude/queue
> [!success] 2026-05-17 — 7[r8[?25h[?25l[?2004h[?1004h[?2031h]0;✳ Claude Code▗[1C▗[3C▖[1C▖[2CClaude[1CCode[1Cv2.1.143
...
- [x] **35-9** 手札干渉>山札戻しに「おたがい」型・「山札の下にもどす」型パターンを追加し、手札干渉>トラッシュに「相手は相手自身の手札を〜トラッシュ」型パターンを追加する #claude/queue
> [!success] 2026-05-17 — 7[r8[?25h[?25l[?2004h[?1004h[?2031h]0;✳ Claude Code▗[1C▗[3C▖[1C▖[2CClaude[1CCode[1Cv2.1.143
...
- [x] **35-7** 独自タグ「カウンター効果」を「カウンター効果（ダメカン以外）」にリネームし、ダメカン操作>反射と重複しないよう条件を絞り込む #claude/queue
> [!success] 2026-05-17 — 7[r8[?25h[?25l[?2004h[?1004h[?2031h]0;✳ Claude Code▗[1C▗[3C▖[1C▖[2CClaude[1CCode[1Cv2.1.143
