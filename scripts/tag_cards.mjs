...
const TAG_RULES = [
  ...
  // §B-9-9  無効>グッズ / 無効>サポート（旧 §B-8-4 ロック>トレーナー効果無効・Phase 35-3）
  // 免疫型: 相手がグッズ/サポートを使っても効果を受けない
  {
    tags: ['無効', '無効>グッズ', '無効>サポート'],
    condition: (all) => /グッズまたはサポートを出して使ったとき.{1,30}効果を受けない/.test(all),
  },
  {
    tags: ['無効', '無効>サポート'],
    condition: (all) => /手札からサポートを出して使ったとき.{1,30}効果を受けない/.test(all),
  },
...
const GROUP_ORDER = [
  ...
  // §B-26 ベンチ保護
  '無効', '無効>ベンチへのワザダメージ', '無効>ベンチへの効果とダメージ', '無効>ワザの効果のみ', '無効>ダメカン配置', '無効>コイントス', '無効>条件付き', '無効>グッズ', '無効>サポート',
...
const SECTION_MAP = {
  ...
  '逃げる操作': '§B-27',
  'ロック': '§B-8','ロック>特性': '§B-8','ロック>スタジアム': '§B-8','ロック>にげられない': '§B-8','ロック>エネルギー': '§B-8','軽減': '§B-9',
