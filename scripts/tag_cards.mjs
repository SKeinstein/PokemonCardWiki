...
const GROUP_ORDER = [
  ...
  // ── Phase 33 新軸② 親タグ群（判定ロジックは 33-B〜F で実装、現段階では予約のみ） ──
  'ワザダメージ', 'ダメカン直置き', '与ダメージ修飾', '受けるダメージ軽減', '受けるダメージ無効', 'ダメカン移動', '耐性', '耐性>ワザの効果', '耐性>グッズの効果', '耐性>サポートの効果', '耐性>ベンチ効果', '耐性>特殊状態',
...
const SECTION_MAP = {
  ...
  '無効':               '§B-26',
  'ダメージ操作':       '§B-24',
  'ワザダメージ': '§Phase33', 'ダメカン直置き': '§Phase33', '与ダメージ修飾': '§Phase33',
  '受けるダメージ軽減': '§Phase33', '受けるダメージ無効': '§Phase33', 'ダメカン移動': '§Phase33',
