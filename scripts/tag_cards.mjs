...
const TAG_RULES = [
  ...
  // ── §B-30  ポケモンのどうぐ>参照 ─────────────────────────────────────────
  //   どうぐ装着の有無・数を条件とする効果（スタジアム>参照に相当）
  //   例: ダイノーズ「がついているなら」/ ロトム系「の数×」
  {
  ...
  },
  {
    ...
    // 参照系（がついているなら / の数×）は §B-30 ポケモンのどうぐ>参照 へ移行
    condition: (all) =>
      /ポケモンのどうぐ/.test(all) &&
      !/「ポケモンのどうぐ」がついているなら/.test(all) &&
      !/「ポケモンのどうぐ」の数/.test(all),
...
const GROUP_ORDER = [
  ...
  'カード種別参照>ポケモンのどうぐ', 'カード種別参照>どうぐトラッシュ', 'カード種別参照>特殊エネルギー',
  // §B-26 ベンチ保護
...
const SECTION_MAP = {
  ...
  'ポケモンのどうぐ': '§B-30', 'ポケモンのどうぐ>参照': '§B-30',
  ...
  'カード種別参照>ポケモンのどうぐ': '§B-28', 'カード種別参照>どうぐトラッシュ': '§B-28', 'カード種別参照>特殊エネルギー': '§B-28',
  'タイプ変更':         'D-4', 'ワザコピー': 'D-4',
  '退化':               'D-4',
  '無効':               '§B-26',
  'ダメージ操作':       '§B-24',
