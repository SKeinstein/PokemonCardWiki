...
const GROUP_ORDER = [
  ...
  'ロック', 'ロック>グッズロック', 'ロック>サポートロック', 'ロック>ACE SPECロック', 'ロック>トレーナー効果無効', 'ロック>特性', 'ロック>スタジアム',
...
const SECTION_MAP = {
  ...
  'ロック': '§B-8','ロック>トレーナー効果無効': '§B-8','ロック>特性': '§B-8','ロック>スタジアム': '§B-8','軽減': '§B-9',
  'カウンター効果':     '§B-10','自傷':        '§B-11','自傷>ダメカン': '§B-11','自傷>ダメージ': '§B-11','ベンチ展開': '§B-12','ベンチ展開>山札': '§B-12','ベンチ展開>トラッシュ': '§B-12',
  '進化加速':           '§B-13','進化加速>ルール制限解除': '§B-13','進化加速>条件進化': '§B-13','山札破壊':    '§B-14',
