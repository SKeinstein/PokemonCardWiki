...
const TAG_RULES = [
  ...
  // 「このポケモンにダメカンを…のせ、」形式（のせる省略形: ウネルミナモ）も含む
  {
    tags: ['ダメカン操作>のせる'],
    condition: (all) =>
      (/ダメカンを.{1,30}のせる/.test(all) || /このポケモンにダメカンを.{1,30}のせ/.test(all)) &&
  ...
  {
    tags: ['ロック', 'ロック>にげられない', 'ロック>にげられない>ワザ'],
  ...
  // ── §B-10  被ダメージ時発動（カウンター）────────────────────────────────
  // ダメカン操作>反射（HANSHA_PAT）と重複するカードは除外
...
const GROUP_ORDER = [
  ...
  '逃げる操作', '逃げる操作>コスト無償',
  'ロック', 'ロック>ワザ', 'ロック>どうぐ', 'ロック>グッズ', 'ロック>サポート', 'ロック>ACE SPEC', 'ロック>特性', 'ロック>スタジアム', 'ロック>にげられない', 'ロック>にげられない>ワザ',
...
const SECTION_MAP = {
  ...
  'ロック': '§B-8','ロック>特性': '§B-8','ロック>スタジアム': '§B-8','ロック>にげられない': '§B-8','ロック>にげられない>ワザ': '§B-8','軽減': '§B-9',
  ...
  'カード種別参照>特殊エネルギー': '§B-28', 'カード種別参照>スタジアム': '§B-28',
  'タイプ変更':         'D-4', 'ワザコピー': 'D-4',
  '退化':               'D-4',
  '無効':               '§B-26',
  'ダメージ操作':       '§B-24',
