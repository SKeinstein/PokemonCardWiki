...
const TAG_RULES = [
  ...
  // §B-1-T2  トラッシュ回収>場: トラッシュから場へ（ベンチに出す・ポケモンにつける）
  //   エネ加速>トラッシュ と意図的に重複付与（直接装着）
  {
...
const GROUP_ORDER = [
  ...
  'トラッシュ回収', 'トラッシュ回収>手札', 'トラッシュ回収>場', 'トラッシュ回収>山札',
...
const SECTION_MAP = {
  ...
  'エネ除去': '§B-6',
  'ロック付与':         '§B-7','逃げる操作': '§B-27','逃げる操作>コスト無償': '§B-27','逃げる操作>相手ロック': '§B-27','逃げる操作>自分ロック': '§B-27','ロック': '§B-8','ロック>トレーナー効果無効': '§B-8','軽減': '§B-9',
