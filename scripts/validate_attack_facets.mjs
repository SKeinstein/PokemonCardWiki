...
const LABELS = {
  ...
  S1: 'ベンチに届く', S2: '自分側', S3: 'お互い', S4: 'バトル場のみ',
...
const REGRESSION = [
  ...
  // Phase 33-X (1-B): notable + !S1 + !S3 → S4 を補完 (バトル場のみ)
  ['テツノイワオex', 'リパルサーアックス', ['M2', 'T4', 'C1', 'S4']],
  ['危ない廃墟', null, ['M2', 'T3', 'C1', 'C6', 'S1']],
  ['マシマシラ', 'アドレナブレイン', ['M3', 'T3', 'C2', 'C8', 'S1']],
  ['ウネルミナモex', 'カタルシスロアー', ['M1', 'T1', 'C7', 'S4']],
  ['ヤクデ', 'ヒートダイブ', ['M1', 'T1', 'C1', 'S2', 'S4']],
  ['トドロクツキ', 'あだうちやばね', ['M1', 'T1', 'C5', 'C6', 'S4']],
  ['テツノカイナ', 'ちょうごうきんハンド', ['M1', 'T1', 'C6', 'S4']],
];
